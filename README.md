...
**Porda AI** – a powerful and innovative everyday AI companion, thoughtfully designed for the Muslim community.
Porda AI empowers users to uphold modesty and decency in the digital world by intelligently detecting and blurring **non-Mahram** and **haram** (NSFW) content — directly on screen, whether **online or offline, across browsers, video players, or any application, at any time!**
...
- **Coding:** welcoming you to contribute:)
- **Tutorial:** welcoming you to contribute:)
...
here's the commands might help:

```bash
  # for Bash Terminal (eg. Linux/Unix) OS:

  git clone https://github.com/hijam-git/Porda-AI/
  cd Porda-AI
  python -m venv venv # if failed, try "py -m venv venv"
  source venv/Scripts/activate.bat
  python -m pip install -r requirements.txt # or, pip install -r requirements.txt
```

```cmd
    # for Windows CMD Terminal OS:
...
- **Every positive change is welcomed — we're waiting for your push!**
